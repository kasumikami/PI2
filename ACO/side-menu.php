        ...
        <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="?page=login"><i class="fa fa-circle-o"></i> Administrador</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Biblioteca</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Leitor</a></li>
              </ul>
            </li>
            <li>
                <form class="form-control-sm">
                    <input class="form-control" type="text" placeholder="Pesquisar" aria-label="Search" style="width: 175px; margin-left: 1em; margin-top: 1em">
                </form>
            </li>
          </ul>
        </nav>
